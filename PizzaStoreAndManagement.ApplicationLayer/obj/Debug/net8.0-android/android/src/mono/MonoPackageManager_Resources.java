...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "PizzaStoreAndManagement.ApplicationLayer.dll" comes first in this list. */
		"PizzaStoreAndManagement.ApplicationLayer.dll",
		...
		"Microsoft.Maui.Controls.resources.dll",
		"Microsoft.Maui.Controls.resources.dll",
		"PizzaStoreAndManagement.DomainLayer.dll",
		"PizzaStoreAndManagement.Persistance.dll",
